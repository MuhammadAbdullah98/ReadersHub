            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-winku">
                        <h4>How to view recommended books</h4>
                        <span><p>You can view all the recommended books on ReadersHub.</p></span>

                        <h6>•Pictorial Illustration</h6>
                        <img src="images/capture_20200511204843.png" alt="">
                       <span> <p>By clicking on "recommendations" you can view all the recommended books on ReadersHub.</p></span>

<span>
                       <img src="images/capture_20200511204942.png" alt="">
                       <span> <p>You can also view ReadersHub footer to view recommended books.</p></span>
