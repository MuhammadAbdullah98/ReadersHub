            ...
            <div class="carousel-item active">
                <div class="row">
                    <div id="{{ book['isbn'] }}" class="book">
                        <a href='https://www.goodreads.com/book/show/{{ book["goodreads_book_id"] }}'>
                          <img id='book_image' src="{{ book['image_url'] }}"/>
                        </a>
                        {{ book['title'] }}<br/>
                    <a href="{{ url('book_recommendations', id_goodreads=book['goodreads_book_id']) }}">Find Similar Books</a>
                      </div>
                    <div class="col-md-2">
                        <div class="card">
                            <div class="card-body">
