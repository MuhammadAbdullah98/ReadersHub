            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-winku">
                        ...
                        <span><p>Reader’s Hub provide best recommended author’s to it’s user based on user interest. Using an effective recommendation algorithms and techniques we provide best recommended author’s to our users . User can follow them to see their next recommended book in your suggestion list. Following are some recommended author’s that we suggest our user’s for must read.</p></span>
                        <h3>SOME RECOMMENDED AUTHOR'S FOR MUST READ</h4>
                        <span><h6>•J.K.Rowling, Mary GrandPré</h6>
                            <p>
                                ...
                                GrandPré did all that with almost no input from Rowling herself. She told that she didn't even meet or speak to the "Harry Potter" creator until after "Harry Potter and the Prisoner of Azkaban," the third book in the series, was published in 1999.
                            ...
                            <h6>•Stephenie Meyer</h6>
                            <p>Stephenie Meyer is best known for authoring the best-selling 'Twilight' book series, which was adapted into a hit film franchise.
