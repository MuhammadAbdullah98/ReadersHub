            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-winku">
                        <h4>How to verify account on ReadersHub.</h4>
                        <span><p>You need to verify your account in order to access more functionality on ReadersHub.</p></span>

                        <h6>•Pictorial Illustration</h6>
                        <img src="images/capture_20200511211025.png" alt="">
                       <span> <p>By clicking on "Register" verification link should be send to your email address.</p></span>

<span>

                       <span> <p>By clicking on "click here to request another" in case you did'nt recieve verification link.</p></span>
